...
const History = ({ uniqueTitle,changeTitle }) => {
  const handleClick =()=>{
    changeTitle(uniqueTitle)
  }
  return (
    <ol>
      <li onClick={handleClick} className="relative z-[15]" style={{ opacity: "1", height: "auto" }}>
        <div className="group relative rounded-lg active:opacity-90 hover:bg-gray-700">
          <div className="flex items-center gap-2 p-2">
            <div className="relative grow overflow-hidden whitespace-nowrap">
              {uniqueTitle}
            </div>
          </div>
          <div className="absolute bottom-0 right-0 top-0 items-center gap-1.5 pr-2  ">
            <button  className="">
              <svg
                width="24"
                height="24"
