...
const Feed = ({ feedState, setFeedState }) => {
  const { value, message, previousChats, currentTitle } = feedState;
  ...
  return (
    <div className="flex overflow-y-scroll bg-feedbg w-full h-screen flex-col items-center text-left">
      <div className="flex mb-3 h-24 w-24">
        <svg
          width="41"
          height="41"
          viewBox="0 0 41 41"
      ...
      <h2 className="mb-5 text-2xl font-medium">Hello I'm NOTGPT</h2>
                ...
                <div className="flex items-center justify-center overflow-hidden rounded-full">
                  <div className="relative flex">
                    <img
                      ...
                      src="https://lh3.googleusercontent.com/a/AEdFTp5od__IW28EpVDfR_QQ9LSLij0aed8V_deNDf6a8g=s96-c"
        ...
        <div className="flex w-full items-center">
          <div className="overflow-hidden  flex flex-col w-full  flex-grow relative border dark:text-white rounded-2xl ">
            ...
            <button
              disabled={disabled}
              onClick={getMessages}
              className="absolute bottom-1.5 right-2 rounded-lg border p-0.5 text-white transition-colors enabled:bg-white disabled:text-gray-400 disabled:opacity-10 dark:border-white dark:bg-white dark:hover:bg-white md:bottom-3 md:right-3"
            >
